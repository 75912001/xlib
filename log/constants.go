...
var traceIDKeyString0 = fmt.Sprintf("[%v:]", TraceIDKey) // 当 TID 为 0 时的字符串

const (
	logChannelEntryCapacity = 100000               // 日志 通道 条目 最大容量
	logTimeFormat           = "15:04:05.000000"    // 日志时间格式 时:分:秒.微秒
	callerInfoFormat        = "line:%d file:%s %s" // 堆栈信息格式 例如 line:69 file:xxx server/xxx/xx/x/log.TestExample
