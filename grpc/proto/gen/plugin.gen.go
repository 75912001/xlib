...
func genFunction(g *protogen.GeneratedFile, file *protogen.File) {
	for _, service := range file.Services {
		...
		g.P("\topts = append([]", grpcPackage.Ident("DialOption"), "{")
		...
		g.P("\t\t", grpcPackage.Ident("WithDefaultCallOptions"), "(")
		g.P("\t\t\t", grpcPackage.Ident("MaxCallRecvMsgSize"), "(", xconfigPackage.Ident("GConfigMgr"), ".Grpc.GetMaxReceiveMessageBytes()),")
		g.P("\t\t\t", grpcPackage.Ident("MaxCallSendMsgSize"), "(", xconfigPackage.Ident("GConfigMgr"), ".Grpc.GetMaxSendMessageBytes()),")
		g.P("\t\t),")
